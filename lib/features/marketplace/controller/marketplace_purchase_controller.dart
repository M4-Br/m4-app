...
class MarketplacePurchaseController extends BaseController {
  ...
  Future<void> _processPurchase() async {
    await executeSafe(() async {
      ...
      final newSale = MarketplaceSale(
        userId: userRx.userId!,
        marketplaceProductId: int.parse(item.id),
        quantity: 1,
        totalValue: item.marketplaceValue,
      ...
      Get.offNamed(AppRoutes.marketplaceReceipt, arguments: {
        'item': item,

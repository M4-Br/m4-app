...
class AuthChangePswPage extends GetView<AuthChangePswController> {
  const AuthChangePswPage({super.key});
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        focusedErrorBorder: const UnderlineInputBorder(
          borderSide: BorderSide(color: colorRed, width: 2), // Linha vermelha focada em erro
        ),

...
class _HomeCardState extends State<HomeCard> {
  ...
  Widget build(BuildContext context) {
    ...
    cardColor = userData.payload.cardColor;

    fontColor = userData.payload.cardFontColor;
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          WidgetsBinding.instance.addPostFrameCallback((_) {
            Get.defaultDialog(
              ...
              content: Column(
                children: [
                  Text('Erro ao obter o saldo. Tente novamente'),
                  ElevatedButton(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: [cardColor, Colors.white.withOpacity(0.3)],
        ),
      ),
      child: Padding(

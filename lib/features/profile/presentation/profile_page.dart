      ...
      child: Theme(
        ...
        child: Column(
          children: [
            ...
            _buildSimpleMenuItem(Icons.factory_outlined, 'CNPJ',
                () => Get.toNamed(AppRoutes.companyManager)),
            _buildDivider(),
            _buildSimpleMenuItem(Icons.settings_suggest_outlined,
                'PERSONALIZAÇÃO', () => Get.toNamed(AppRoutes.customization)),
            _buildDivider(),

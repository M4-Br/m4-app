...
import 'package:app_flutter_miban4/core/helpers/utils/app_button.dart'; // Adicionado
...
class PartnerManagementPage extends GetView<PartnerManagementController> {
          ...
          children: [
            ...
            if (controller.myProducts.isEmpty)
              ...
              ...controller.myProducts.map((item) {
                final formattedValue = item.partnerValue.toBRL();
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              TextField(
                controller: controller.editPartnerCtrl,
                inputFormatters: [
                  FilteringTextInputFormatter.digitsOnly,
                  CurrencyFormatter()
                ],

...
class PartnerReceiptPage extends GetView<PartnerReceiptController> {
  const PartnerReceiptPage({super.key});

  @override
  Widget build(BuildContext context) {
    final valParceiro =
        'R\$ ${controller.item.partnerValue.toStringAsFixed(2).replaceAll('.', ',')}';

...
import 'package:app_flutter_miban4/core/helpers/extensions/numbers.dart'; // Import da sua extensão
...
class PartnerPurchasePage extends GetView<PartnerPurchaseController> {
  const PartnerPurchasePage({super.key});

  @override
  Widget build(BuildContext context) {
    final valMercado = 'R\$ ${controller.item.marketValue.toBRL()}';
    final valDesconto = 'R\$ ${controller.item.discount.toBRL()}';
    final valParceiro = 'R\$ ${controller.item.partnerValue.toBRL()}';

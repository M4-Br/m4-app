...
class OnboardingPages {
  static final List<GetPage> pages = [
    ...
    GetPage(name: AppRoutes.onboardingStepOne, page: () => const OnboardingStepOnePage()),
    GetPage(name: AppRoutes.onboardingStepTwo, page: () => const OnboardingStepTwoPage()),
    GetPage(name: AppRoutes.onboardingStepThree, page: () => const OnboardingStepThreePage()),
    GetPage(name: AppRoutes.onboardingStepFour, page: () => const OnboardingStepFourPage()),
    GetPage(name: AppRoutes.onboardingStepFive, page: () => const OnboardingStepFivePage()),
    GetPage(name: AppRoutes.onboardingStepSix, page: () => const OnboardingStepSixPage()),
    GetPage(name: AppRoutes.onboardingStepSeven, page: () => const OnboardingStepSevenPage()),
    GetPage(name: AppRoutes.onboardingStepEight, page: () => const OnboardingStepEightPage()),
    GetPage(name: AppRoutes.onboardingPhoneConfirm, page: () => const OnboardingPhoneConfirmPage()),
    GetPage(name: AppRoutes.onboardingEmailConfirm, page: () => const OnboardingEmailConfirmPage()),
    GetPage(name: AppRoutes.onboardingDocumentChoose, page: () => const OnboardingDocumentChoosePage()),
    GetPage(name: AppRoutes.onboardingSelfieConfirm, page: () => const OnboardingSelfieConfirmPage(result: {},)),
    GetPage(name: AppRoutes.onboardingPasswordRegister, page: () => const OnboardingPasswordRegisterPage()),
    GetPage(name: AppRoutes.onboardingPrivacyPolicy, page: () => const OnboardingPrivacyPolicyPage()),
    GetPage(name: AppRoutes.onboardingReview, page: () => const OnboardingInReviewPage()),
    GetPage(name: AppRoutes.onboardingApproved, page: () => const OnboardingApprovedPage()),

...
Future<Map<String, dynamic>> getGroupData(String id) async {
  try {
    ...
    final response = await http.get(
      Uri.parse('${ApiUrls.baseUrl}/group_accounts/$id/invites?per_page=30'),
      headers: headers,
    );
    ...
    if (response.statusCode == 200) {
      ...
      final Map<String, dynamic> responseBody = json.decode(response.body);
      Get.snackbar(code == 'pt' ? "Mensagem" : "Message", responseBody['message'] ?? ['error_message'],

...
Future<Map<String, dynamic>> getCreditTerms() async {
  ...
  final response = await http
      .get(Uri.parse('${ApiUrls.baseUrl}/mutual_terms/last'), headers: headers);
  ...
  if (response.statusCode == 200) {
    ...
    final jsonMap = json.decode(response.body);
    final responseBody = jsonMap['message'] ?? jsonMap['error_message'];
    Get.snackbar(codeLang == 'pt' ? "Mensagem" : "Message", responseBody,

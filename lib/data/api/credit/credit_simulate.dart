...
Future<Map<String, dynamic>> simulateCredit(String groupId, String amount) async {
  ...
  final body = {"group_account_id": groupId, "amount": amount};

  final response = await http.post(
      Uri.parse("${ApiUrls.baseUrl}/mutual_users/simulate"),
      headers: headers,
      body: body);
